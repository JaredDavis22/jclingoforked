...
public class Function extends Ast {
    ...
    public int getExternal() {
        ...
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_get_number(ast, AstAttribute.EXTERNAL.getValue(), intByReference));
    ...
    public void setExternal(int external) {
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_set_number(ast, AstAttribute.EXTERNAL.getValue(), external));
    }
