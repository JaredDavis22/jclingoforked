...
public class Edge extends Ast {
    ...
    public Ast getNodeU() {
        ...
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_get_ast(getPointer(), AstAttribute.NODE_U.getValue(), pointerByReference));
        return Ast.borrowChild(pointerByReference.getValue());
    }

    public Ast getNodeV() {
        PointerByReference pointerByReference = new PointerByReference();
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_get_ast(getPointer(), AstAttribute.NODE_V.getValue(), pointerByReference));
        return Ast.borrowChild(pointerByReference.getValue());
    }
    ...
    public void setNodeU(Ast nodeU) {
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_set_ast(getPointer(), AstAttribute.NODE_U.getValue(), nodeU.getPointer()));
    }

    public void setNodeV(Ast nodeV) {
        Clingo.check(Clingo.INSTANCE.clingo_ast_attribute_set_ast(getPointer(), AstAttribute.NODE_V.getValue(), nodeV.getPointer()));
    }
