...
public class TheoryUnparsedTerm extends Ast {
    ...
    private static Pointer create(Location location, AstSequence elements) {
        ...
        Clingo.check(Clingo.INSTANCE.clingo_ast_build(AstType.THEORY_UNPARSED_TERM.getValue(), pointerByReference, location, elements.getPointer(), new NativeSize(elements.size())));
